package com.cellent.employee.kafka;
...
public class KafkaStreamConfig {
  ...
  //  StreamsBuilder builder=new StreamsBuilder();
    ...
    config.put(StreamsConfig.COMMIT_INTERVAL_MS_CONFIG, 3);
...
KafkaStreamsConfiguration configuration=new KafkaStreamsConfiguration(config);
